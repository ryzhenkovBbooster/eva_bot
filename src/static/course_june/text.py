...
def info_message(name):
    return f"@{name} Уведомления в чатах нашей компании выключены, поэтому," \
           " чтобы @DenKravchuk мог оперативно реагировать на ваши сообщения, пожалуйста," \
           " пишите через @логин в тексте сообщения или используйте функцию 'ответить', чтобы он ничего не упустил."
...
def rename_email_static(name, additional_email, oldEmail, username):
    return f" {name}, привет! Я переименовала вашу почту на должностную и открыла доступы." \
           " Теперь вам доступны все файлы вашего департамента на Google Диске!" \
